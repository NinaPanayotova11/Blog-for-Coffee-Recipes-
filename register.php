            ...
            $("#register").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        } else if (response === 'First name is too short') {
                            $("#add_err").html('<div class="alert alert-danger"> \
                                <strong>First Name</strong> is required. \ \
                                </div>');
												 
						            } else if (response === 'Last name is too short') {
                            $("#add_err").html('<div class="alert alert-danger"> \
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4">
                                ...
                                <input type="text"
                                id="lname" name="lname" maxlegth="25"  class="form-control">
                            </div>
                            <div class="form-group col-lg-4">
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="password" 
                                id="password" name="password" maxlegth="250"  class="form-control">
                            </div>
                            <div class="form-group col-lg-12">
                                <button type="submit" 
                                id="register" class="btn btn-default">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
